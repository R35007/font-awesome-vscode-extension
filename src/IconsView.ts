...
export class IconsView implements vscode.WebviewViewProvider {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const { showIconInfo, iconFamily, iconSize, zoom, searchText, copySnippetAs, matchWholeWord, viewType } = this.viewState;
    ...
    <body>
        <div class="info-container">
            ...
            <div id="icon-info-container" class="row m-0" style="justify-content: center; align-items: end; display: ${showIconInfo ? "flex" : "none"}">
                <div id="selected-icon-image" class="selected-icon-image col" title="click here to save icon">
            ...
            <div class="row" id="selected-icon-category-badges" style="gap: 8px; margin: 1rem 0;">
            ...
            <div class="row search-container">
              ...
              <vscode-button id="view-toggle-btn" class="view-toggle-btn" data-current-view="${viewType}" title="Toggle View">
                ${ViewTypeIcon[viewType as keyof typeof ViewTypeIcon]}
              </vscode-button>
              <vscode-button id="invert-bg-btn" class="invert-bg-btn" title="Invert Color">
        ...
        <ul id="icons-list" class="icons-list icons-list--${viewType}" style="--icon-size: ${iconSize}px">
